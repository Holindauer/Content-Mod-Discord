...
a tokenizer that was trained on both the conll2003 and only the toxic
comments from the wikipedia training set
   ...
   #####################################################################################################################################################
    ...
    def load_tokenizer(bucket_name, tokenizer_path):
        ...
        s3.download_file(bucket_name, 
                         f"{tokenizer_path}conll_toxic_wiki_tokenizer-vocab.txt", 
                         f"{local_tokenizer_path}conll_toxic_wiki_tokenizer-vocab.txt")

        # Load BertWordPieceTokenizer using vocab.txt
        return BertTokenizer.from_pretrained(f"{local_tokenizer_path}conll_toxic_wiki_tokenizer-vocab.txt", do_lower_case=True)
    ...
    #The new tokenizer
    tokenizer_path = 'tokenizer-with-toxic-wiki/'
