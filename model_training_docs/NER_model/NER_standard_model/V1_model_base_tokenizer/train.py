...
if __name__ == "__main__":
   ...
   #####################################################################################################################################################
    ...
    def load_tokenizer(bucket_name, tokenizer_path):
        ...
        s3.download_file(bucket_name, f"{tokenizer_path}tokenizer.json", f"{local_tokenizer_path}tokenizer.json")
        s3.download_file(bucket_name, f"{tokenizer_path}vocab.txt", f"{local_tokenizer_path}vocab.txt")
        s3.download_file(bucket_name, f"{tokenizer_path}tokenizer_config.json", f"{local_tokenizer_path}tokenizer_config.json")
        s3.download_file(bucket_name, f"{tokenizer_path}special_tokens_map.json", f"{local_tokenizer_path}special_tokens_map.json")
    ...
    tokenizer_path = 'bert-tokenizer-fast/'
